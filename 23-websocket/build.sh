#!/usr/bin/env bash
# build.sh — Compila y empaqueta el módulo 23-websocket usando el toolchain portable.
# Uso: ./build.sh
set -euo pipefail

# Raíz del roadmap (dos niveles arriba de este script).
...
echo "==> Artefacto: $(dirname "${BASH_SOURCE[0]}")/target/websocket-1.0.0.jar"
