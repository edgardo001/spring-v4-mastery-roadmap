...
JAR="target/cache-1.0.0.jar"
[[ -f "$JAR" ]] || { echo "ERROR: $JAR no existe"; exit 1; }
echo "OK: $JAR listo. Ejecutar con:  java -jar $JAR"
echo "GET  http://localhost:8080/api/items/1   (1ra vez ~500ms, 2da instantáneo)"
echo "DELETE http://localhost:8080/api/items/1 (invalida caché)"
